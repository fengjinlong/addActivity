						...
						<div class="well with-header project">
							...
							<div class="row form-group-margin">
                                ...
                                <div class="form-group col-lg-4 col-md-4 col-sm-6">
                                    ...
                                    <div class="col-sm-9 no-padding-right">
                                        <select id="branchSchoolId" name="branchSchoolId" class="form-control chosen-select" onchange="branchSchoolChange()">
                                        </select>
                                    </div>
                                </div>
								<div class="clearfix form-group">
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                     ...
                     <div class="well with-header">
                        ...
                        <div class="well with-header projectPayFees3">
							...
							<button class="btn1" onclick="submitServiceFun()" id="submitService" data-toggle="button" >新增服务</button>
							<button class="btn2" onclick="appendProjectFun()" id="appendProject" data-toggle="button" >添加产品</button>
							<button class="btn3" onclick="submitProjectFun()" id="submitProject" data-toggle="button" >新增产品</button>
                        </div>
...
<!--子产品课程信息回显  -->
<script src="${ctx_static }/home/consultcenter/js/consultWorkbench_projectInfoC.js"></script>
<!--公共弹框-课程信息部分动态回显  -->
...
<script src="${ctx_static }/home/consultcenter/js/consultWorkbench_payFeesC.js"></script>
...
<!--待沟通-新增咨询量  -->
<script src="${ctx_static }/home/consultcenter/js/consultWorkbench_addProject.js"></script>
...
<!-- 报名-继续购买产品 -->
<script src="${ctx_static }/home/consultcenter/js/consultWorkbench_continueToBuy.js"></script>
...
<!--咨询模块滚动提醒  -->
<script src="${ctx_static }/dep/scroll/scroll.js"></script>
