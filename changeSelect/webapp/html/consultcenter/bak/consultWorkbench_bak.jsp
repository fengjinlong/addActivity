...
<link href="${ctx_static }/dep/bootstrap-datetimepicker/css/bootstrap-datetimepicker.css" rel="stylesheet"/>
...
<div class="page-body">
	...
	<div class="row margin-bottom-15">
		<div class="col-lg-10 col-md-12 col-sm-12 col-xs-12 no-padding-right">
			<div class="tabbable tabs-left">
				<ul class="nav nav-tabs" id="myTab3">
					<li class="tab-sky active">
						<a onclick="initCount('week')" data-toggle="tab" href="#home3">
							周度
						</a>
					</li>

					<li class="tab-red">
						<a onclick="initCount('quarter')" data-toggle="tab" href="#home3">
							月度
						</a>
					</li>

					<li class="tab-orange">
						<a onclick="initCount('month')" data-toggle="tab" href="#home3">
							季度
						</a>
					</li>

					<li class="tab-orange">
						<a onclick="initCount('year')" data-toggle="tab" href="#home3">
							年度 
						</a>
					</li>

					<li class="tab-orange">
						<a onclick="initCount('sum')" data-toggle="tab" href="#home3">
							总计
						</a>
					</li>
				</ul>
				<div class="tab-content tab_content_1 text-center">
					<div id="home3" class="tab-pane active">
						...
						<div class="col-lg-3 no-padding-left no-padding-right">
                                <div class="col-lg-4 col-lg-offset-1 col-md-6 col-sm-6 col-xs-6 ranking no-padding-left no-padding-right padding-top-10">
                                    <span id="zn" class="graded ranking-num blue">
                                        --<i class="fa fa-long-arrow-up margin-left-10" style="font-size:20px;color:red"></i>
                                    </span>
                                    <p class="text-center ranking-wen">组内排名</p>
                                </div>
                                <div class="col-lg-4 col-lg-offset-2 col-md-6 col-sm-6 col-xs-6 ranking no-padding-left no-padding-right padding-top-10">
                                    <span id="zpm" class="graded ranking-num blue">
                                        --<i class="fa fa-long-arrow-down margin-left-10" style="font-size:20px;color:green"></i>
                                    </span>
                                    <p class="text-center ranking-wen">总排名</p>
                                </div>
                           </div>
					</div>
				</div>
		...
		<div class="col-lg-2 col-md-6 col-sm-6 col-xs-12 touxiang">
			<div style="background:#fff;min-height:162px;" class="touxiang-box">
				...
				<p class="nc_name text-center">${currentUser.realName }</p>
			</div>
			
		</div>
	</div>
	<div class="row">
		<div class="col-lg-11 col-md-9 col-sm-12 col-xs-12 no-padding-right">
			<div class="widget">
							...
							<div class="tab-content tabs-flat bordered-blue">
								...
								<div id="shangmen" class="tab-pane">
									<div class="row row_padding form-horizontal">
										<div class="col-lg-12 col-md-12 col-sm-12 no-padding">
											<div class="col-lg-5 col-md-5 col-sm-5 form-group">
												<label class="pull-left control-label" style="margin-left:15px;">日期</label>
												<div class="col-sm-10">
													<div class="input-group">
														<input type="text" class="form-control" id="reservation3">
														<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
													</div>
												</div>
											</div>
									...
									<div class="row row_padding form-horizontal">
										<div class="col-lg-12 col-md-12 col-sm-12 no-padding">
											<div class="form-group col-lg-5 col-md-5 col-sm-5 col-xs-12">
												...
												<div class="col-sm-10">
													<div class="input-group">
														<input type="text" class="form-control" id="reservation4">
														<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
													</div>
												</div>
											</div>
										...
										<div class="col-lg-12 col-md-12 col-sm-12 no-padding">
											<div class="form-group col-lg-5 col-md-5 col-sm-5 form-horizontal">
												...
												<div class="col-sm-10">
													<div class="controls">
														<div class="input-group">
															<input type="text" class="form-control" id="reservation5">
															<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
														</div>
													</div>
												</div>
		...
		<div class="col-lg-1 col-md-3 col-sm-12 col-xs-12 mg_top">
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body  form-horizontal modal_padding">
						...
						<div class="well with-header">
							...
							<div class="row form-group-margin gt_content">
								...
								<div class="form-group col-lg-4 col-md-4 col-sm-6">
									...
									<div class="col-sm-9">
										<input name="phoneBelong"  disabled="disabled" id="departmentId11" name="departmentId1" class="form-control phoneBelong comment_disabled" placeholder="--请选择--">
						...
						<!-- <div class="well with-header">
							...
							<div class="row form-group-margin">
								<div class="form-group col-lg-4 col-md-4 col-sm-6">
									...
									<div class="col-sm-9">
										<select name="projectId"  id="project1" class="form-control comment_disabled" disabled="disabled">
											
										</select>
										<input id="projectName1" name="projectName" type="hidden">
									</div>
								</div>
								...
								<div class="form-group col-lg-4 col-md-4 col-sm-6">
									...
									<div class="col-sm-9">
										<select name="projectLevelId" id="projectLevel1" class="form-control comment_disabled" disabled="disabled"> 
											
										</select>
										<input id="projectLevelName1" name="projectLevelName" type="hidden">
									</div>
								</div>
								...
								<div class="form-group col-lg-4 col-md-4 col-sm-6">
									...
									<div class="col-sm-9">
										<select id="classId1" name="classId" class="form-control comment_disabled" disabled="disabled">
										<select class="productId" name="productId" class="form-control comment_disabled" disabled="disabled">
											
										</select>
										<input id="classAttr1" name="classAttr" type="hidden">
										<input id="schoolId1" type="hidden"/>
									</div>
								</div>
								...
								<div class="form-group col-lg-4 col-md-4 col-sm-6">
									...
									<div class="col-sm-9">
										<input id="classPrice1" type="text" class="form-control comment_disabled"  disabled="disabled">
									</div>
								</div>
								...
								<div class="form-group col-lg-4 col-md-4 col-sm-6">
									...
									<div class="col-sm-9">
										<select id="kTime1" name="kTime" class="form-control comment_disabled" disabled="disabled">
										</select>
										<input id="kTimeValue1" name="kTimeValue" type="hidden">
									</div>
								</div>
				...
				<!-- <ul class="tab_content tab_net tab_content_11">
					<li><a href="javascript:void(0);"><i class="fa-call"></i>
						<div><p id="callPhone1">拨打</p></div></a>
					</li>
					<li><a href="javascript:void();"><i class="fa-huifang"></i>
						<div><p class="special">追加回访记录</p></div></a>
					</li>
					<li><a href="javascript:void(0);"><i class="fa-message"></i>
						<div><p>发送短信</p></div></a>
					</li>
					<li>
						<a data-toggle="modal" data-target=".subscribe"><i class="fa-yuyue"></i>
						<div><p >转为预约</p></div>
						</a>
					</li>
					<li class="mg_bottom"><a href="javascript:void(0);"><i class="fa-email"></i>
						<div><p>发送邮件</p></div></a>
					</li>
				</ul> -->
					...
					<div class="col-lg-12 col-sm-12 col-xs-12">
						...
						<div class="well with-header">
							<div class="header bordered-blue">
								...
								<!-- <input name="dPrice" id="dPrice" type="hidden" />
								<input name="dPriceType" id="dPriceType" type="hidden" /> -->
							...
							<div class="row form-group-margin gt_content">
								...
								<div class="form-group col-lg-4 col-md-4 col-sm-6">
									...
									<div class="col-sm-9">
										<input name="studentPhone" id="studentPhone2" type="text" class="form-control">
									</div>
								</div>
								<div class="form-group col-lg-4 col-md-4 col-sm-6">
									<label class="col-sm-3 control-label no-padding-right">邮箱：</label>
                                ...
                                <div class="form-group col-lg-4 col-md-4 col-sm-6">
                                    <label class="col-sm-5 control-label no-padding-right" style="margin-left:-41px">报名方式</label>
                                    <div class="col-sm-9">
                                        <select id="infoType2" name="infoType" class="form-control comment_disabled">
                                        	<c:if test="${fn:contains(sessionScope.userTypeDataRoleIds,'4')}">
                                            	<option id="xszf"  value="0">线上支付</option>
                                             </c:if>
                                             <c:if test="${fn:contains(sessionScope.userTypeDataRoleIds,'5')}">
                                            	<option id="smbm"  value="1">上门报名</option>
                                             </c:if>
                                        </select>
                                    </div>
                                </div>
						...
						<div class="well with-header project">
							...
							<div class="row form-group-margin">
								...
								<div class="form-group col-lg-12 col-md-12 col-sm-12">
                                    <label class="col-sm-2 control-label no-padding-right" style="margin-left:-70px;">优惠类型</label>
                                    <div class="col-sm-11 preferentialType">
                                        <div class="checkbox col-sm-2">
                                            <label>
                                                <input id='preferential' type="checkbox" class="preferential comment_disabled" name="preferential" >
                                                <span class="text">优惠</span>
                                            </label>
                                        </div>
                                        <c:if test="${type eq '3' }">
                                        	 <c:set value="disabled" var="jtyh" />
                                        </c:if>
                                        <c:if test="${type eq '1' }">
                                        	 <c:set value="disabled" var="fxyh" />
                                        </c:if>
                                       <%--  <div class="col-sm-5 no-padding" style="margin-left:-92px">
                                        	<label class="control-label col-sm-4 no-padding-right">
                                                <span class="text">集团</span>
                                            </label>
											<div class="col-sm-8">
                                            	<input onchange="jiaoyan5(this)" onkeyup="jiaoyan5(this)" name="selfYH" id="selfYH2" ${jtyh }  type="number" class="form-control" value="">
                                            </div>
                                        </div>
                                        <div class="col-sm-5 no-padding">
                                         	<label class="control-label col-sm-4">
                                                <span class="text">分校</span>
                                            </label>
											<div class="col-sm-8">
                                            <input onchange="jiaoyan5(this)"  onkeyup="jiaoyan5(this)" ${fxyh } name="ortherYH"  id="ortherYH2" type="number" class="form-control" value="">
                                            </div>
                                        </div> --%>
                                    </div>
                                    <div class="col-sm-8 holidayPromoCode">
                                        <div class="checkbox col-sm-4">
                                            <label>
                                                <input type="checkbox" class="holidayPromo comment_disabled" name="holidayPromo"  >
                                                <span class="text">假日优惠码</span>
                                            </label>
                                        </div>
                                        <div class="col-sm-6 no-padding padding-right-5" style="margin-top:15px">
                                            <input autocomplete="off" onpaste="return false" type="text" id="activtyCode2" onkeyup="activtyCode(this,classPrice2)" class="form-control" value="">
                                        </div>
                                    </div>
                                </div>
								<div class="clearfix form-group">
						...
						<div class="well with-header">
							...
							<table class="table table-striped table-hover table-bordered dataTable no-footer">
								...
								<tr id="dztr">
									...
									<div class="col-sm-5">
									     <input id="dingzuoI" name="payValue" class="form-control" type="text" value="0">
									 </div>
									<div class="col-sm-3">
									</div>
									</div>
									...
									<td colspan="5">
										<div class="form-group col-lg-6 col-md-6 col-sm-6">
		                                    ...
		                                    <div class="input-group col-sm-8 payment-time"> 
		                                        <input value="" name="nextPayTime" id="nextPayTime" class="form-control paymentTime" type="text">
		                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
		                                    </div>
		                                </div>
...
<div class="modal fade strategy in" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div id="gonglueText" class="modal-body  form-horizontal" style="height:650px">
				<div class="tabbable">
                     <ul class="nav nav-tabs tabs-flat" id="myTab11">
                         <li class="active">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body  form-horizontal modal_padding">
                <form method="" class="form-horizontal" style="padding:0 20px">
                    <div id="addPayTd1" class="clear_both position_rel">
                        <h5 class="xian hide_content"><i class="fa fa-angle-down"></i>培训费 欠费合计:<span style="color: red;" id="pxfp"></span></h5>
                        <div class="pull-right">
                            <a href="javascript:void(0);" class="btn btn-info btn-xs  add_row"><i
                                    class="fa fa-plus-circle"></i></a>
                        </div>
                        <div class="row clear_both form_margin">
                            <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <select name="pxfs" class="form-control col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <input placeholder="0" onkeyup="bufei(this)" name="pxft" class="form-control" type="number">
                            </div>
                        </div>
                    </div>

					<div id="addPayTd2" class="position_rel">
                        <h5 class="xian_1 hide_content"><i class="fa fa-angle-down"></i> 考务费（D）欠费合计:<span style="color: red;" id="kwfp"></span></h5>
                        <div class="pull-right">
                            <a href="javascript:void(0);" class="btn btn-info btn-xs  add_row"><i
                                    class="fa fa-plus-circle"></i></a>
                        </div>
                        <div class="row clear_both form_margin">
                            <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <select name="kwfs" class="form-control col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <option value="Xj">现金</option>
                                    <option value="Sk">刷卡</option>
                                    <option value="Zp">支票</option>
                                    <option value="Weixin">汇款-微信</option>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <input placeholder="0" onkeyup="bufei(this)" name="kwft" class="form-control form-control" type="number">
                            </div>
                        </div>
                    </div>

					<div id="addPayTd3" class="position_rel">
                        <h5 class="xian_1 hide_content"><i class="fa fa-angle-down"></i> 资料费（D）欠费合计:<span style="color: red;" id="zlfp"></span></h5>
                        <div class="pull-right">
                            <a href="javascript:void(0);" class="btn btn-info btn-xs  add_row"><i
                                    class="fa fa-plus-circle"></i></a>
                        </div>
                        <div class="row clear_both form_margin">
                            <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <select name="zlfs" class="form-control col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <option value="Xj">现金</option>
                                    <option value="Sk">刷卡</option>
                                    <option value="Zp">支票</option>
                                    <option value="Weixin">汇款-微信</option>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <input placeholder="0" onkeyup="bufei(this)" name="zlft" class="form-control" type="number">
                            </div>
                        </div>
                    </div>

					<div id="addPayTd4" class="position_rel">
                        <h5 class="xian hide_content"><i class="fa fa-angle-down"></i> 协议费 欠费合计:<span style="color: red;" id="xyfp"></span></h5>
                        <div class="pull-right">
                            <a href="javascript:void(0);" class="btn btn-info btn-xs  add_row"><i
                                    class="fa fa-plus-circle"></i></a>
                        </div>
                        <div class="row clear_both form_margin">
                            <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <select name="xyfs" class="form-control col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                   <option value="Xj">现金</option>
                                    <option value="Sk">刷卡</option>
                                    <option value="Zp">支票</option>
                                    <option value="Weixin">汇款-微信</option>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <input placeholder="0" onkeyup="bufei(this)" name="xyft" class="form-control" type="number">
                            </div>
                            <!--<a href="javascript:void(0);" class="btn btn-info btn-xs  minus_row"><i class="fa fa-minus-circle"></i></a>-->
                        </div>
                    </div>

					<div id="addPayTd5" class="position_rel">
                        <h5 class="xian_1 hide_content"><i class="fa fa-angle-down"></i> 教材费（D）欠费合计:<span style="color: red;" id="jcfp"></span></h5>
                        <div class="pull-right">
                            <a href="javascript:void(0);" class="btn btn-info btn-xs  add_row"><i
                                    class="fa fa-plus-circle"></i></a>
                        </div>
                        <div class="row clear_both form_margin">
                            <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <select name="jcfs" class="form-control col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <option value="Xj">现金</option>
                                    <option value="Sk">刷卡</option>
                                    <option value="Zp">支票</option>
                                    <option value="Weixin">汇款-微信</option>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <input placeholder="0" onkeyup="bufei(this)" name="jcft" class="form-control" type="number">
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="addPayTd6" class="position_rel">
                        <h5 class="xian_1 hide_content"><i class="fa fa-angle-down"></i> 服务费（D）欠费合计:<span  style="color: red;"id="fufp"></span></h5>
                        <div class="pull-right">
                            <a href="javascript:void(0);" class="btn btn-info btn-xs  add_row"><i
                                    class="fa fa-plus-circle"></i></a>
                        </div>
                        <div class="row clear_both form_margin">
                            <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <select name="fufs" class="form-control col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <option value="Xj">现金</option>
                                    <option value="Sk">刷卡</option>
                                    <option value="Zp">支票</option>
                                    <option value="Weixin">汇款-微信</option>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <input placeholder="0" onkeyup="bufei(this)" name="fuft" class="form-control" type="number">
                            </div>
                        </div>
                    </div>
...
<div class="modal fade zxmx in" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div id='callInfo' class="modal-body  form-horizontal">
						...
						<!-- <div class="well with-header">
							...
							<div class="row form-group-margin">
								...
								<div class="form-group col-lg-4 col-md-4 col-sm-6">
									<label class="col-sm-3 control-label no-padding-right">价格：</label>
									<div class="col-sm-9">
										<input type="text" class="form-control comment_disabled" value="1000" disabled="disabled">
									</div>
								</div>
								
								<div class="form-group col-lg-12 col-md-12 col-sm-12">
									<label style="margin-left: -70px !important;" class="col-sm-2 col-lg-2 control-label no-padding-right">优惠类型：</label>
									<div class="checkbox col-sm-2 col-lg-2 no-padding-right no-padding-left">
										<label>
											<input type="checkbox" class="benefit">
											<span class="text">集团分校10%</span>
										</label>
									</div>
									<div class="col-sm-9 col-lg-9  col-md-12 no-padding-left youhui" style="display:none;">
										<div class="form-group col-sm-3 col-md-3">
											<input type="text" class="form-control comment_disabled" placeholder="呼出咨询师3%" disabled="disabled">
										</div>
										<div class="form-group col-sm-3 col-md-3">
											<input type="text" class="form-control comment_disabled" placeholder="呼出组长2%" disabled="disabled">
										</div>
										<div class="form-group col-sm-3 col-md-3">
											<input type="text" class="form-control comment_disabled" placeholder="分校咨询师3%" disabled="disabled">
										</div>
										<div class="form-group col-sm-3 col-md-3">
											<input type="text" class="form-control comment_disabled" placeholder="分校经理/咨询经理2%" disabled="disabled">
										</div>
									</div>
									<div class="checkbox col-sm-2 no-padding-left no-padding-right col-sm-offset-1">
										<label class="week">
											<input type="checkbox" class="benefit_ma">
											<span class="text">假日优惠码</span>
										</label>
									</div>
									<div class="form-group col-sm-3 youhuima no-padding-left no-padding-right" style="display:none;">
										<input type="text" class="form-control comment_disabled" placeholder="优惠码输入框" disabled="disabled">
									</div>
								</div>
                        ...
                        <div class="well with-header">
                            ...
                            <div class="row form-group-margin gt_content" id="personInfo">
								...
								<div class="form-group col-lg-4 col-md-4 col-sm-6">
									<label class="col-sm-5 control-label no-padding-right" style="margin-left:-41px">证件类型：</label>
                                    <div class="col-sm-9">
                                       <input type="text" name="" id="stuCardType"
                                               class="form-control comment_disabled padding-right-5 padding-left-10"
                                               disabled="disabled">
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-lg-4 col-md-4 col-sm-6">
                                	<label class="col-sm-5 control-label no-padding-right" style="margin-left:-41px">报名方式：</label>
                                    <div class="col-sm-9">
                                       <input type="text" name="" id="stuBMType"
                                               class="form-control comment_disabled padding-right-5 padding-left-10"
                                               disabled="disabled">
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-lg-4 col-md-4 col-sm-6">
                                    <label class="col-sm-4 control-label no-padding-right no-padding-left" style="margin-left:-20px">最高学历：</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="studentAttrName3" id="stuStudentAttrName32"
                                               class="form-control comment_disabled padding-right-5 padding-left-10"
                                               disabled="disabled">
                                    </div>
                                </div>
                        ...
                        <!-- <div class="well with-header">
                            ...
                            <div class="row form-group-margin" id="courseInfo">
                                ...
                                <div class="form-group col-lg-4 col-md-4 col-sm-6">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control comment_disabled" value="1000" disabled="disabled" id="bkyx">
                                    </div>
                                </div>
                            </div>
                        </div> -->
...
<script type="text/javascript">
	function appendPayDivValue(infoManageId, payCode) {
		$.post("'+ctx +'/consultBookingSeats/appendPayDivValue",{"infoManageId":infoManageId,"payCode":payCode},function(data){
			$("#"+payCode+"_value").append(data);
		},"json");
	}
</script>
<!--下拉框插件-->
