                        ...
                        <div class="entryForm col-md-12">
                            ...
                            <div class="entryForm-body">
                                <table class="table table-bordered text-center">
                                    ...
                                    <tr class="text-center bg-darkgray">
                                        <td colspan="12">课程信息</td>
                                    </tr>
                                    <tr>
                                        <td>类型</td>
                                        <td>${project.projectType eq '1'?'职业资格':'学历' }</td>
                                        <td>项目</td>
                                        ...
                                        <td>授课形式</td>
                                        <td>
                                        <c:if test="${projectLevel.teachType eq '1' }">
                                        	面授
                                        </c:if>
                                        <c:if test="${projectLevel.teachType eq '2' }">
                                        	直播
                                        </c:if>
                                         <c:if test="${projectLevel.teachType eq '3' }">
                                         	录播
                                        </c:if>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>考试地域</td>
                                        <td>${consultInfo.examRegion }</td>
                                        <td>班型</td>
                                        <td>${consultInfo.classAttr }</td>
                                        <td>班号</td>
                                        <td>-</td>
                                    </tr>
                                    <tr class="text-center bg-darkgray">
                                        <td colspan="12">缴费信息</td>
                                    </tr>
                                    <tr>
                                        <td>收费项目</td>
                                        <td colspan="2">应缴</td>
                                    ...
                                    <tr>
                                        <td>服务费（D）</td>
                                        <td class="tsum" colspan="2">${payInfoData.payFw}</td>
                                        <td class="ttsum" colspan="2">
                                        	${payInfoData.payFwNum}
                                        </td>
                                        <td colspan="2">
                                        	${payInfoData.payFwSk eq null || payInfoData.payFwSk eq '' || payInfoData.payFwSk eq 0?'':'刷卡缴费:'}${payInfoData.payFwSk eq null || payInfoData.payFwSk eq '' || payInfoData.payFwSk eq 0?'':payInfoData.payFwSk}
                                        	${payInfoData.payFwWeixin eq null || payInfoData.payFwWeixin eq '' || payInfoData.payFwWeixin eq 0?'':'微信缴费:'}${payInfoData.payFwWeixin eq null || payInfoData.payFwWeixin eq '' || payInfoData.payFwWeixin eq 0?'':payInfoData.payFwWeixin}
                                        	${payInfoData.payFwXj eq null || payInfoData.payFwXj eq '' || payInfoData.payFwXj eq 0?'':'网络缴费:'}${payInfoData.payFwWl eq null || payInfoData.payFwWl eq '' || payInfoData.payFwWl eq 0?'':payInfoData.payFwWl}
                                        	${payInfoData.payFwXj eq null || payInfoData.payFwXj eq '' || payInfoData.payFwXj eq 0?'':'现金缴费:'}${payInfoData.payFwXj eq null || payInfoData.payFwXj eq '' || payInfoData.payFwXj eq 0?'':payInfoData.payFwXj}
                                        	${payInfoData.payFwZfb eq null || payInfoData.payFwZfb eq '' || payInfoData.payFwZfb eq 0?'':'支付宝缴费:'}${payInfoData.payFwZfb eq null || payInfoData.payFwZfb eq '' || payInfoData.payFwZfb eq 0?'':payInfoData.payFwZfb}
                                        	${payInfoData.payFwZp eq null || payInfoData.payFwZp eq '' || payInfoData.payFwZp eq 0?'':'支票缴费:'}${payInfoData.payFwZp eq null || payInfoData.payFwZp eq '' || payInfoData.payFwZp eq 0?'':payInfoData.payFwZp}
                                        	${payInfoData.payFwZz eq null || payInfoData.payFwZz eq '' || payInfoData.payFwZz eq 0?'':'转账缴费:'}${payInfoData.payFwZz eq null || payInfoData.payFwZz eq '' || payInfoData.payFwZz eq 0?'':payInfoData.payFwZz}
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>未领取</td>
                                        <td>
                                        	${consultInfo.zlContent}
                                        </td>
                                    </tr>
                                    <tr class="text-center bg-darkgray">
                                        <td colspan="12">学员服务大厅</td>
                                    </tr>
                                    <tr>
                                        <td>用户名</td>
                                        <td>${consultInfo.studentPhone }</td>
                                        ...
                                        <td>网址：</td>
                                        <td colspan="2">www.xuehuiwang.com</td>
                                    </tr>
                                    <tr style="height:150px">
                                        <td>说明</td>
                                        <td colspan="7">
                                        	<c:forEach items="${config}" var="e">
												${e.configDesc }                                        		
                                        	</c:forEach>
                                        </td>
                                    </tr>
                                    <tr class="text-center bg-darkgray">
                                        <td colspan="12">培训项目服务协议</td>
                                    </tr>
                                    <tr style="border:none">
                                        <td colspan="4" style="border:none" class="text-left">甲方：北京学慧网教育科技有限公司</td>
                                        <td colspan="4" style="border:none"></td>
                                        <td colspan="2" class="pull-left" style="border:none">乙方：</td>
                                    </tr>
                                    <tr style="border:none" class="text-left">
                                        <td colspan="12" style="border:none;padding-left:47px;padding-right:47px">
                                    ...
                                    <tr style="border:none;">
                                        <td class="text-left" colspan="3" style="border:none">甲方：北京学慧网教育科技有限公司 </td>
                                        <td colspan="4" style="border:none"></td>
                        ...
                        <table class="table table-bordered text-center" style="border:none">
                            <tbody>
                                <tr style="border:none">
                                    ...
                                    <td class="col-md-1 text-right margin-left-30" style="border:none">审核人员（签字）：</td>
                                    ...
                                    <td class="col-md-3" style="border:none">客服专线：400-960-6080</td>
                                </tr>
                                <tr style="border:none">
                                    <!-- <td style="border:none" class="col-md-1"></td> -->
...
function print(){
	window.open(ctx+"/printController/index/"+infoManageId+"/xhwEntryFormPrint/"+$('#select').find('option:selected').val());
}
</script>
</html>
