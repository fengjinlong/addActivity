	...
	<div class="col-lg-12 col-sm-12 col-xs-12">
		<div class="widget">
			<div class="widget-header bordered-bottom bordered-blue">
                 <span class="widget-caption">收入明细</span>
            </div>
			<!--Widget Header-->
			<div class="widget-body">
				<div class="widget-main">
						...
						<div class="col-md-10 col-sm-10 col-xs-10">
							<div class="form-group col-md-3 col-sm-3 no-margin-right">
                                <div class="input-group">
                                    <input type="text" id="dateString" class="form-control duration" id="dateString" placeholder="日期">
                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                </div>
                            </div> 
                            <div class="form-group col-md-4 col-sm-4 no-margin-right">
                                <input class="form-control" placeholder="分校/课程/级别/报名编号/姓名/收款人" id="key" type="text">
                            </div>
					...
					<div class="dataTables_wrapper form-inline no-footer" >
						<div class="table-scrollable" id="stuServiceCenterInfo">
							<table
...
<script src="${ctx_static }/home/financeCenter/js/incomeDetails.js?v=<%=Math.random() %>"></script>
<script src="${ctx_static }/home/financeCenter/js/incomeDetailsService.js?v=<%=Math.random() %>"></script>
