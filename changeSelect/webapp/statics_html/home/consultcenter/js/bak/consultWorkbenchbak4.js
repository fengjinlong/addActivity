...
//    //攻略--迁移入consultWorkbench_strategy.js
...
//    //关闭弹窗同时关闭攻略--迁移入consultWorkbench_strategy.js
...
function publicJsonModel(record) {
    ...
    //控制课程缴费信息部分订座费的展示
    $('#dztr').hide();//默认点击查看时，一进来订座费隐藏，只有选中考期时才会展示
...
//     
    ...
    $('#zxjl').html('<tr><td>' + record.conversation + '</td></tr>');//公共弹框呼入-咨询记录
    $('#callInfo2').html('<tr><td>' + record.conversation + '</td></tr>');//报名查看弹框呼入-咨询记录
    //上门未报名原因回显
...
//迁移入consultWorkbench_strategy.js
///**
// * 初始化攻略列表职业
// * @returns
// */
...
//}
//迁移入-consultWorkbench_strategy.js
