$(function () {
	...
	$(".dataTables_wrapper").each(function(){
		$(this).find("input[name='checkedAll']").click(function(){
		...
		$(this).find("input[name='checkbox']").click(function () {
			var flags=true;
			$(this).parents("tbody").find("input[name='checkbox']").filter(function () {
				if(!$(this).prop("checked")){
					return flags=false;
				}
			});
			$(this).parents("table").find("input[name='checkedAll']").prop("checked", flags);
		});
