                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <table class="table table-bordered text-center" style="border:none">
                            <tbody>
                                <tr style="border:none">
                                    <td class="col-md-4 text-right" style="border:none">经办人（签字）：</td>
...
function print(){
	window.open(ctx+"/printController/index/"+infoManageId+"/zhEntryFormTrainPrint/"+$('#select').find('option:selected').val());
}
</script>
</html>
