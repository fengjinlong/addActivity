...
<div class="workbenchPage page-wrapper">
	...
	<div class="row">
		<div class="col-lg-10 col-md-9 col-sm-12 col-xs-12 no-padding-right">
			<div class="widget">
		...
		<div class="col-lg-2 col-md-3 col-sm-12 col-xs-12 mg_top">
					...
					<div class="col-lg-12 col-sm-12 col-xs-12">
						...
						<div class="well with-header">
							<div class="header bordered-blue">
								...
								<input type="hidden" name="param1" id="param1" value=""/><!--存放页面订座，报名部分父div的id  -->
								<input type="hidden" name="param2" id="param2" value=""/><!--存放页面订座，报名部分下次缴费时间的id  -->
						...
						<div class="well with-header">
							...
							<table class="table table-striped table-hover table-bordered dataTable no-footer">
								...
								<tr id="dztr">
									...
									<div class="col-sm-5">
									     <input id="dingzuoI" onblur="dingzuoFees(this);" name="payValue" class="form-control" type="text" placeholder="0">
...
<script type="text/javascript">
//$("#"+payCode).parent()=tr
	function appendPayDivValue(infoManageId, payCode, dPrice) {
		$.post(ctx +"/consultConsoleSignUp/appendPayDivValue",{"infoManageId":infoManageId,"payCode":payCode},function(data){
			if(data.status=="success") {
				if(payCode==null||typeof(payCode) == "undefined") {
					...
					if(payCode=='code_sign') {//如果费用类型是报名费还需要加上订座费
