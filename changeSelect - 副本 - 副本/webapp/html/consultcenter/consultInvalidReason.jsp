    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
       		<div class="widget-header bordered-bottom bordered-blue">
                 <span class="widget-caption">无效原因</span>
            </div>
                    ...
                    <div class="row row_padding form-horizontal">
                        <div class="col-md-5 col-sm-6 col-xs-12">
                            <div class="form-group col-md-9 col-sm-4 no-margin-right">
                                <input class="form-control" placeholder="名称" type="text" id="searchVal" name="searchVal" onkeydown="search();">
                            </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bordered-blue">
                ...
                <span class="widget-caption">创建无效原因</span>
            </div>
            <div class="modal-body clearfix">
                <form class="form-horizontal clearfix" id="inquiries" method="post">
					<!-- 咨询课程 -->
                    <div class="counselCurriculum col-sm-12 no-padding">
	                    <div class="form-group col-sm-12" style="margin-left:-50px">
	                        <label class="control-label col-sm-2 pull-left">无效原因</label>
	                        <div class="col-sm-10 ">
	                            <input class="form-control consultInvalidReasonName" name="consultInvalidReasonName" type="text">
	                        </div>
	                    </div>
	                    <!-- 富文本编辑器 -->
	                    <div class="form-group col-sm-12 dialogueRecord">
	                        <label class="control-label col-md-2 col-sm-3 no-padding-right margin-left padding-right-20">说明<span id="talk"> </span></label>
	                        <div class="col-sm-10">
							  <textarea name="content" id="content" class="content" style="width:500px;height:400px;visibility:hidden;"></textarea>
	                          <script>
								$.getScript('${ctx_static }/dep/kindeditor-4.1.7/kindeditor-min.js', function() {
									KindEditor.basePath = '${ctx_static }/dep/kindeditor-4.1.7/';
									editor = KindEditor.create('textarea.content',{
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bordered-blue">
                ...
                <span class="widget-caption">无效原因信息</span>
            </div>
            <div class="modal-body clearfix">
                <form class="form-horizontal clearfix" id="editRecordForm">
                    <div class="counselCurriculum col-sm-12 no-padding">
	                    <div class="form-group col-md-12" style="margin-left:-50px">
	                        <label class="control-label col-sm-2 pull-left" style="">无效原因</label>
	                        <div class="col-sm-10">
	                           <input type="text" class="form-control consultInvalidReasonName" name="consultInvalidReasonName" id="addConsultInvalidReasonName">
	                           <input type="hidden" class="form-control consultInvalidReasonId" name="consultInvalidReasonId" id="addConsultInvalidReasonId">
	                        </div>
	                    </div>
	                    <!--富文本编辑器  -->
	                    <div class="form-group col-sm-12 dialogueRecord">
	                        <label class="control-label col-md-2 col-sm-3 no-padding-right margin-left">说明</label>
	                        <div class="col-md-9 col-sm-9">
							  <textarea name="content" id="content2" class="content2" style="width:500px;height:400px;visibility:hidden;"></textarea>
	                          <script>
								$.getScript('${ctx_static }/dep/kindeditor-4.1.7/kindeditor-min.js', function() {
									KindEditor.basePath = '${ctx_static }/dep/kindeditor-4.1.7/';
									editor2 = KindEditor.create('textarea.content2',{
										uploadJson:'${ctx }/file/uploadFile',
										resizeType:0
									});
								});
	...
	return {
		init: function () {
			var dutyTable = $('#infoManage').dataTable({
            	...
            	"sAjaxSource" : ctx+'/consultInvalidReason/load',
                ...
                "aoColumns" : [
						{"mData": "consultInvalidReasonName", 'sClass': "text-center"},
						{
			                "mData": "enable",
			                'sClass': "text-center",
			                "bSortable": false,
			                "mRender": function (data, type, full ) {
			                	debugger;
			                    if(data==1) {
			                    	return '<span style="width: inherit" id="span'+full["consultInvalidReasonId"]+'" onclick="chooseRecord(\''+full["consultInvalidReasonId"]+'\')" class="btn btn-xs btn-use"><i class="fa fa-check-circle-o"></i> 启用</span>';
			                    } else {
			                    	return '<span style="width: inherit" id="span'+full["consultInvalidReasonId"]+'" onclick="chooseRecord(\''+full["consultInvalidReasonId"]+'\')" class="btn btn-xs btn-nouse"><i class="fa fa-ban"></i> 禁用</span>';
			                    }
			                }
			            },
						{
			                ...
			                "bSortable": false,
			                "mRender": function (data, type, full ) {
			                    var u = '<shiro:hasPermission name="consultInvalidReason:edit"><a onclick="edit(\''+full["consultInvalidReasonId"]+'\',\''+full["consultInvalidReasonName"]+'\',\''+full["content"]
			                    ...
			                    if(full.enable==0){
			                    	var d = '<span style="width: inherit" id="span'+full["consultInvalidReasonId"]+'" onclick="chooseRecord(\''+full["consultInvalidReasonId"]+'\')" class="btn btn-xs btn-nouse"><i class="fa fa-ban"></i> 禁用</span>';
					          	}else{
					          		var d = '<span style="width: inherit" id="span'+full["consultInvalidReasonId"]+'" onclick="chooseRecord(\''+full["consultInvalidReasonId"]+'\')" class="btn btn-xs btn-use"><i class="fa fa-check-circle-o"></i> 启用</span>';
					          	}
			                    return u;
			                }
			            }
...
<script src="${ctx_static }/home/consultcenter/js/consultInvalidReason.js"></script>