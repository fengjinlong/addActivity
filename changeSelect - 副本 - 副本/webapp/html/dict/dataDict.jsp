...
<link href="${ctx_static }/home/dict/css/dataDict.css" rel="stylesheet">
			...
			<div class="modal-body clearfix">
				<form class="form-horizontal" id="subjectAdd" method="post">
					<div class="form-group col-sm-12">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control examSubjectName" name="dataTypeName">
						</div>
					</div>
					<div class="form-group col-sm-12">
						<label class="control-label col-sm-2 no-padding-right">编码</label>
						<div class="col-sm-9">
							<input type="text" class="form-control examSubjectName" name="dataTypeCode">
						</div>
					</div>
					<div class="form-group col-sm-12">
	...
	<div class="modal-dialog modal-md">
		<div class="modal-content">
			...
			<div class="modal-body clearfix">
				...
				<input id="dataTypeId" type="hidden"/>
					<div class="form-group col-sm-12">
						<label class="control-label col-sm-2 no-padding-right">类别</label>
						<div class="col-sm-9">
							<input type="text" class="form-control" id="dataTypeName">
						</div>
					</div>
					<div class="form-group col-sm-12">
...
<script src="${ctx_static }/home/dict/js/dataDict.js?v=<%=Math.random() %>"></script> 
