     ...
     <div class="col-xs-12 col-md-12">
         <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                 <span class="widget-caption">系统日志</span>
            </div>
			...
			<div class="col-lg-5 col-md-5 col-xs-12 col-padd">
              ...
              <div role="grid" id="expandabledatatable_wrapper"
                  ...
                  <table id="init" class="table table-striped table-hover table-bordered dataTable no-footer">
                      <thead>
                      <tr role="row">
                      	 <th>异常信息<span class="fa indicator "></span></th>
                          <th>登录账号 <span class="fa indicator"></span></th>
                          <th>登录人 <span class="fa indicator"></span></th>
                          <th>登录ip<span class="fa indicator "></span></th>
                          <th>登录时间<span class="fa indicator "></span></th>
...
<script src="${ctx_static }/home/syslog/js/loginLog.js?v=+<%=Math.random() %>"></script>