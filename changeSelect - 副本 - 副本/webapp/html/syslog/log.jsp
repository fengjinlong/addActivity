     ...
     <div class="col-xs-12 col-md-12">
         <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                 <span class="widget-caption">操作日志</span>
            </div>
			...
			<div class="col-lg-5 col-md-5 col-xs-12 col-padd">
                                     <div class="form-group col-md-7 col-sm-7 no-margin-right">
                                         <input type="text" value="*:*" id="searchVal" class="form-control" placeholder="部门 / 姓名 / 发布人 / 状态" onkeydown="search()">
                              </div>
              ...
              <div role="grid" id="expandabledatatable_wrapper"
                  ...
                  <table id="init" class="table table-striped table-hover table-bordered dataTable no-footer">
                      ...
                      <tr role="row">
                          ...
                          <th>操作账号 <span class="fa indicator "></span></th>
                          <th>操作日期</th>
                          <th>登录ip<span class="fa indicator "></span></th>
                          <th>操作页面<span class="fa indicator "></span></th>
...
<script src="${ctx_static }/home/syslog/js/log.js?v=<%=Math.random() %>"></script>