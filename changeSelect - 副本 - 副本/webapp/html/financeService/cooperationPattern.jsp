    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
           	<div class="widget-header bordered-bottom bordered-blue">
                 <span class="widget-caption">合作模式配置</span>
            </div>
            <!--Widget Header-->
                ...
                <div class="widget-main">
                    <div class="row row_padding form-horizontal">
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="form-group col-md-7 col-sm-7 no-margin-right">
                                <input class="form-control" id="searchName" placeholder="合作模式名称" type="text">
                            </div>
                    ...
                    <div class="dataTables_wrapper form-inline no-footer">
                        <div class="table-scrollable">
                            <table class="table table-striped table-hover table-bordered dataTable no-footer" id="cooperationPattern">
                                <thead>
                                <tr>
                                    <th>合作模式名称</th>
                                    <th>状态</th>
...
<!--合作模式配置新增-->
<div class="modal fade cooperation-pattern-add" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body clearfix">
                <form class="form-horizontal clearfix" id="cooperationPatternAdd">
                    <div class="form-group col-sm-12">
                        <label class="control-label col-sm-2 no-padding-right">合作模式名称：</label>
                        <div class="col-sm-10">
                            <input name="financeServicePatternName" class="form-control">
                        </div>
                    </div>
                    <div class="form-group col-sm-12">
                        <label class="control-label col-sm-2 no-padding-right">服务场景：</label>
                        <div class="col-sm-10">
                            <select name="financeServiceConfIds" id="confs"
...
<!--合作模式配置编辑-->
<div class="modal fade cooperation-pattern-edit" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bordered-blue">
            ...
            <div class="modal-body clearfix">
                <form class="form-horizontal clearfix" id="cooperationPatternEdit">
             		<input type="hidden" name="financeServicePatternId" id="financeServicePatternId">
                    <div class="form-group col-sm-12">
                        <label class="control-label col-sm-2 no-padding-right">合作模式名称：</label>
                        <div class="col-sm-10">
                            <input name="financeServicePatternName" class="form-control">
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <div class="col-sm-10">
                            <select name="financeServiceConfIds"
                                    class="form-control selectpicker" multiple disabled
                                    title="--请选择--">
...
<script src="${ctx_static }/home/cooperationModel/js/cooperationPattern.js"></script>