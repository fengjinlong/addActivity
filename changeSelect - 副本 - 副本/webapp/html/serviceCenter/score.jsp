...
<link href="${ctx_static }/home/serviceCenter/css/score.css" rel="stylesheet">
				...
				<div class="widget-main">
					<div class="row row_padding form-horizontal">
						<div class="col-md-7 col-sm-7 col-xs-12">
							<div class="form-group col-md-8 col-sm-8 col-lg-8 no-margin-right">
								<input onkeydown="search();" class="form-control searchVal" placeholder="分校/课程/级别/考试时间/姓名/证件号/电话号码" type="text">
							</div>
						...
						<div class="col-md-2 col-sm-2 pull-right">
						   <c:if test="${sessionScope.scoresAdd eq '1' }">
							<button class="btn increase pull-right add-btn" data-toggle="modal" data-backdrop="static" data-target=".scoresAdd">
					...
					<div class="dataTables_wrapper form-inline no-footer">
						<div class="table-scrollable">
							<table class="table table-striped table-hover table-bordered dataTable no-footer" id="score">
								<thead>
...
<!--新增-->
<div class="modal fade scoresAdd" tabindex="-1" role="dialog"
...
<script src="${ctx_static }/home/serviceCenter/js/score.js"></script>
