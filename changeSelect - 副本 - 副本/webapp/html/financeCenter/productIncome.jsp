     ...
     <div class="col-lg-12 col-sm-12 col-xs-12">
         <div class="widget">
             <div class="widget-header bordered-bottom bordered-blue">
                 <span class="widget-caption">产品收支表</span>
             </div>
             <!--Widget Header-->
             <div class="widget-body ">
                 <div class="widget-main clearfix">
                     ...
                     <div class="tabbable col-sm-15">
                         <ul class="nav nav-tabs tabs-flat" id="myTab11">
                             <li class="active">
                                 <a data-toggle="tab" href="#income">收</a>
                             </li>
                             <li>
                                 <a data-toggle="tab" href="#expenses">支</a>
                             </li>
                             <li>
                                 <a data-toggle="tab" href="#receivable">应收款</a>
                             </li>
                         </ul>
                         <div class="tab-content tabs-flat" id="stuServiceCenterInfo">
                             <!-- 收 -->
                             <div id="income" class="tab-pane in active">
                                 <div class="row row_padding form-horizontal">
                                             ...
                                             <div class="col-lg-10 col-md-9 col-sm-9">
                                                 <div class="controls">
                                                     <div class="input-group date">
                                                         <input class="form-control reservation" id="dateString1" type="text"
                                                                placeholder="日期">
                                     ...
                                     <div class="col-md-5 col-sm-6 col-xs-12">
                                         <div class="form-group col-md-9 col-sm-4 no-margin-right">
                                             <input class="form-control" placeholder="姓名/电话/报名表编号/身份证号"
                                                    type="text" id="key1" name="searchVal" >
                                         </div>
                                         <div class="form-group col-md-3 col-sm-4">
                                             <a type="button"  onclick="search1();" class="btn increase form-control search-btn">
                             ...
                             <div id="expenses" class="tab-pane">
                                 <div class="row row_padding form-horizontal">
                                     <div class="col-md-4 col-sm-3 col-xs-12">
                                         <div class="form-group">
                                             <div class="col-lg-10 col-md-9 col-sm-9">
                                                 <div class="controls">
                                                     <div class="input-group date">
                                                         <input class="form-control reservation" id="dateString2"  type="text"
                                                                placeholder="日期">
                                                         <span class="input-group-addon"><i
                                                                 class="fa fa-calendar"></i></span>
                                                     </div>
                                     ...
                                     <div class="col-md-5 col-sm-6 col-xs-12">
                                         <div class="form-group col-md-9 col-sm-4 no-margin-right">
                                             <input class="form-control" placeholder="姓名/电话/报名表编号/身份证号"
                                                    type="text" id="key2" name="searchVal" >
                                         </div>
                                         <div class="form-group col-md-3 col-sm-4">
                                             <a type="button" onclick="search2();" class="btn increase form-control search-btn">
                                                 <i class="fa fa-search"></i> 搜索
                                             </a>
                                         </div>
                                     </div>
                                     ...
                                     <div class="table-scrollable">
                                         <table class="table table-striped table-hover table-bordered dataTable no-footer"
                                             ...
                                             <tr>
                                                 ...
                                                 <td>正常</td>
                                                 <td>
                                                     <a class="view" data-backdrop="static"><i
                                                             class="fa fa-search warning"
                                                             data-toggle="tooltip" data-placement="top"
                                                             data-original-title="查看" title=""></i>
                                                     </a>
                                                 </td>
                                             </tr>
                                             </tbody>
                             ...
                             <!-- 应收款 -->
                             <div id="receivable" class="tab-pane">
                                 <div class="row row_padding form-horizontal">
                                     <div class="col-md-4 col-sm-3 col-xs-12">
                                         <div class="form-group">
                                             <div class="col-lg-10 col-md-9 col-sm-9">
                                                 <div class="controls">
                                                     <div class="input-group date">
                                                         <input class="form-control reservation" id="dateString3" type="text"
                                                                placeholder="日期">
                                                         <span class="input-group-addon"><i
                                                                 class="fa fa-calendar"></i></span>
                                                     </div>
                                     ...
                                     <div class="col-md-5 col-sm-6 col-xs-12">
                                         <div class="form-group col-md-9 col-sm-4 no-margin-right">
                                             <input class="form-control" placeholder="姓名/电话/报名表编号/身份证号"
                                                    type="text" id="key3" name="searchVal" >
                                         </div>
                                         <div class="form-group col-md-3 col-sm-4">
                                             <a type="button" onclick="search3();" class="btn increase form-control search-btn">
                                                 <i class="fa fa-search"></i> 搜索
                                             </a>
                                         </div>
                                     </div>
...
<!--收 详情-->
<div class="modal fade shou " tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bordered-blue">
                ...
                <span class="widget-caption">缴费信息</span>
            </div>
...
<!--应收款 详情-->
<div class="modal fade yinshoukuan " tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bordered-blue">
...
<script src="${ctx_static }/dep/zTree/jquery.ztree.all.min.js"></script>
<script src="${ctx_static }/home/financeCenter/js/productIncome.js?v=<%=Math.random() %>"></script>
<script src="${ctx_static }/home/financeCenter/js/productIncomeService.js?v=<%=Math.random() %>"></script>
