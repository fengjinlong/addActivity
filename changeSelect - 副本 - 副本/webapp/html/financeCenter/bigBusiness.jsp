...
<link href="${ctx_static }/home/financeCenter/css/bigBusiness.css" rel="stylesheet">
								...
								<div class="col-md-9 col-sm-9">
									<div class="controls">
										<div class="input-group date">
											<input type="text" class="form-control duration" id="reservation"
...
<!--申请-->
<div class="modal fade financeApply" tabindex="-1" role="dialog"
				...
				<form class="form-horizontal" id="financeApply">
					...
					<div class="form-group col-sm-12">
                        ...
                        <div class="col-sm-10 padding-left-10">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input  id="pCostclassId"type="text" class="form-control" value="集团分成">
                            </div>
                            <div class="col-sm-4 no-padding-right">
                                <select name="" class="form-control" disabled>
					...
					<div class="form-group col-sm-12 modal-footer">
						<div class="col-sm-2 col-sm-offset-4">
							<button onclick="addApply()" type="button" 
								class="btn btn-primary form-control applay-btn">申请支出</button>
						</div>
						<div class="col-sm-2 ">
...
<script src="${ctx_static }/home/financeCenter/js/bigBusiness.js"></script>
