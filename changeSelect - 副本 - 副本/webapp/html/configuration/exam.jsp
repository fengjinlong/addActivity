	...
	<div class="col-lg-12 col-sm-12 col-xs-12">
		<div class="widget">
			<div class="widget-header bordered-bottom bordered-blue">
                 <span class="widget-caption">报考资料配置</span>
            </div>
			<!--Widget Header-->
					...
					<div class="row row_padding form-horizontal">
						<div class="col-md-4 col-sm-4 col-xs-12">
							<div class="form-group col-md-9 col-sm-8 no-margin-right">
								<input type="text" class="form-control" placeholder="报考资料" id="searchVal" onkeydown="search();">
							</div>
			...
			<div class="modal-body clearfix">
				<form class="form-horizontal" id="subjectAdd" method="post">
					<div class="form-group col-sm-12">
						<label class="control-label col-sm-2 no-padding-right">报考资料</label>
						<div class="col-sm-9">
							<input type="text" class="form-control examSName" name="examName">
						</div>
					</div>
					 <div class="form-group col-sm-12 activityType">
                        <label class="control-label col-sm-2 no-padding-right">格式</label>
                        <div class="col-sm-9">
                            <select name="examType" class="form-control type" >
			...
			<div class="modal-body clearfix">
				...
				<input id="examId" type="hidden"/>
					...
					<div class="form-group col-sm-12 activityType">
                        <label class="control-label col-sm-2 no-padding-right">格式</label>
                        <div class="col-sm-9">
                            <select id="examType" name="examType" class="form-control type" >
                                <option value="1">图片</option>
                                <option value="2">文档</option>
                            </select>
                        </div>
...
<script src="${ctx_static }/home/configuration/js/exam.js?v=<%=Math.random() %>"></script>
