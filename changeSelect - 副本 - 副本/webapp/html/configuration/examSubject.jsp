	...
	<div class="col-lg-12 col-sm-12 col-xs-12">
		<div class="widget">
			<div class="widget-header bordered-bottom bordered-blue">
                 <span class="widget-caption">考试科目配置</span>
            </div>
			<!--Widget Header-->
					...
					<div class="row row_padding form-horizontal">
						<div class="col-md-4 col-sm-4 col-xs-12">
							<div class="form-group col-md-9 col-sm-8 no-margin-right">
								<input type="text" class="form-control" placeholder="考试科目" id="searchVal" onkeydown="search();">
							</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body clearfix">
				<form class="form-horizontal" id="subjectAdd" method="post">
					...
					<div class="form-group col-sm-12">
						<label class="control-label col-sm-2 no-padding-right">考试科目</label>
						<div class="col-sm-9">
							<input type="text" class="form-control examSubjectName" name="examSubjectName">
						</div>
					</div>
					<div class="form-group col-sm-12">
	...
	<div class="modal-dialog modal-md">
		<div class="modal-content">
			...
			<div class="modal-body clearfix">
				...
				<input id="examSubjectIds" type="hidden"/>
					<!-- <div class="form-group col-sm-12">
						<label class="control-label col-sm-2 no-padding-right">类别</label>
						<div class="col-sm-9">
...
<script src="${ctx_static }/home/configuration/js/examSubject.js"></script>
