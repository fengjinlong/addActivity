    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                 <span class="widget-caption">退回原因配置</span>
            </div>
            <!--Widget Header-->
                       ...
                       <!-- <ul class="nav nav-tabs tabs-flat">
                        ...
                        <div class="tab-content">
                            ...
                            <div id="return" class="clearfix">
                                <button class="btn increase pull-right add-line-return" data-toggle="modal" data-backdrop="static">
                                    <i class="fa fa-plus"></i> 新增
                                </button>
                                <form action="" class="col-sm-12">
                                    <table class="table table-bordered table-hover dataTable no-footer add-table add-table-return text-center">
                                        <thead>
                                        <tr role="row">
                                            <th>内容</th>
                                            <th>状态</th>
                                        ...
                                        <tbody>
                                         <c:forEach items="${list1.results }" var="item">
	                                         <c:if test="${item.configType eq '3' }">
	                                        	  <tr>
