...
function retrieveData1(sSource, aoData, fnCallback, oSettings ){
	...
	aoData.push( { "name": "createTime", "value": createTime } );
...
function init1 (){
	var init = $('#init1').dataTable({
		...
		"sAjaxSource" : ctx+'/smallBusiness/loadCheck',
		"bDestroy" : true,
		"bRetrieve" : false,
		"bServerSide" : true,
...
function init2 (){
	var init = $('#init2').dataTable({
		...
		"aoColumns" : [
			...
			{"mDataProp" : "baoMDate","bSortable": false,'sClass': "text-center"},
			{"mDataProp" : "createDate","bSortable": false,'sClass': "text-center"},
			{"mData": "tiuFei", 'sClass': "text-center", "mRender": function (data, type, full ) {
				return data;
			}},
			{"mDataProp" : "payB","bSortable": false,'sClass': "text-center"},
			{"mDataProp" : "payKwNum","bSortable": false,'sClass': "text-center"},
			{"mData": "", 'sClass': "text-center", "mRender": function (data, type, full ) {
				var money = full["payB"] - full["payKwNum"];
				return money;
			}},
...
function init3 (){
	var init = $('#init3').dataTable({
		...
		"aoColumns" : [
			...
			{"mDataProp" : "bmCode","bSortable": false,'sClass': "text-center"},
			{"mData": "infoManagePay", 'sClass': "text-center"},
			{"mDataProp" : "baoMDate","bSortable": false,'sClass': "text-center"},
			{"mDataProp" : "createDate","bSortable": false,'sClass': "text-center"},
			{"mDataProp" : "tiuFei","bSortable": false,'sClass': "text-center"},
			{"mData": "payB","bSortable": false,'sClass': "text-center"},
			{"mDataProp" : "payPxNum","bSortable": false,'sClass': "text-center"},
			{"mData": "", 'sClass': "text-center", "mRender": function (data, type, full ) {
				var money = full["payB"] - full["payKwNum"];
				return money;
...
function init5 (){
	var init = $('#init5').dataTable({
		...
		"aoColumns" : [
			...
			{"mDataProp" : "",'sClass':"text-center", "mRender": function (data, type, full ) {
				return '-';
			}},
			{"mDataProp" : "",'sClass':"text-center", "mRender": function (data, type, full ) {
				return '-';
...
function init6(){
	var init = $('#init6').dataTable({
		...
		"aoColumns" : [
	                    ...
	                    {"mData": "rewardPunishPrice", 'sClass': "text-center", "mRender": function (data, type, full) {
//	                    	console.info(full["jcType"]);
//	                    	if(full["jcType"]==1){
//	                    		return data;
//	                    	}else{
//	                    		return "罚";
