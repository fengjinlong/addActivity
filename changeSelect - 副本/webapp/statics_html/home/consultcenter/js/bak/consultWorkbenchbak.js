...
//    //考期变换-生成费用选项-迁移入consultWorkbench_bookingseats.js
...
//迁移入consultWorkbench_signUp.js中
////缴费
...
//*************************************************迁移至consultWorkbench_visit.js中（starting）*******************************************************************//
/**
 * 初始上门信息
 * @returns
 */
...
//}
//*************************************************迁移至consultWorkbench_visit.js中（ending）*******************************************************************//

//*************************************************迁移至consultWorkbench_bookingseats.js中（starting）*******************************************************************//
/**
 * 初始订座信息
 * @returns
 */
...
//*************************************************迁移至consultWorkbench_bookingseats.js中（ending）*******************************************************************//
...
//    });
//}
/* 注释 上门回调函数迁移至consultWorkbench_visit.js文件中***/
/**
 * 回调函数上门
 * @param sSource
 * @param aoData
...
//
//}
//添加报名补费信息确定，迁移入consultWorkbench_signUp.js
...
//已迁移入consultWorkbench_signUp.js
///**
// * 获取上次欠费记录
// * @returns
// */
...
//    })
//}
//补费-迁移入consultWorkbench_signup.js中
//function isNull(val) {
//    if (val) {
//        return val;
//    } else {
