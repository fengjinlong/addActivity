...
function init (){
	var init = $('#init').dataTable({
		...
		"sAjaxSource" : ctx+'/log/load',
		"bDestroy" : true,
		"bRetrieve" : false,
		"bServerSide" : true,
		"fnServerData" : retrieveData,
		"aoColumns" : [
			{"mDataProp" : "logId",'sClass': "text-center","mRender": function ( data, type, full ) {
			...
			{"mDataProp" : "userName","bSortable": false,'sClass': "text-center"},
              {"mDataProp" : "beginTime","bSortable": false,'sClass': "text-center"},
              /*{"mDataProp" : "dutyName","bSortable": false,'sClass': "text-center"},*/
              {"mDataProp" : "ip","bSortable": false,'sClass': "text-center"},
              {"mDataProp" : "logHtml","bSortable": false,'sClass': "text-center"},
              {"mDataProp" : "type","bSortable": false,'sClass': "text-center","mRender":function(data, type, full ){
            	  return data;
              }},
              {"mDataProp" : "type","bSortable": false,'sClass': "text-center","mRender":function(data, type, full ){
            	  return data;
              ...
              {"mDataProp" : "userId","bSortable": false,'sClass': "text-center","mRender": function ( data, type, full ) {
				return '<a onclick="edit(\''+full["userName"]
				+'\',\''+full["account"]
				+'\',\''+full["beginTime"]
				+'\',\''+full["logIp"]
				+'\',\''+full["ip"]
				...
				+'\',\''+full["type"]
				+'\',\''+full["type"]
				+'\')" class="edit" data-toggle="modal" data-target=".bs-example-modal-sm">'
