...
<!--已报考-->
<div id="alreadyExam" class="tab-pane clearfix in active">
	
	<div class="col-sm-9 alreadyExamInfo no-padding animated bounceInRight">
            ...
            <div class="col-sm-12 no-padding conditions">
                <div class="pull-right">
                    <div class="pull-left form-group">
                     <c:if test="${sessionScope.alreadyExamReg eq '1' }">
                        <button class="btn btn-lightBlue reg" title="学员注册">学员注册</button></c:if>
                    </div>
                    <div class="pull-left form-group">
                    <c:if test="${sessionScope.alreadyExamGoback eq '1' }">
                        <button type="button" title="退回待报考" class="btn btn-lightBlue goback">退回待报考</button></c:if>
                    </div>
                    <div class="pull-left form-group">
                    <c:if test="${sessionScope.alreadyExamThan eq '1' }">
                        <button type="button" title="退回报考费比对" class="btn btn-lightBlue" data-toggle="modal"
                        data-backdrop="static" data-target=".examFeeThan">退回报考费比对
                        </button></c:if>
                    </div>
                    <div class="pull-left form-group">
                     <c:if test="${sessionScope.alreadyExamSend eq '1' }">
                        <button class="btn btn-lightBlue send"  title="申请支出" >申请支出</button></c:if>
                    </div>
                </div>
            </div>
		</div>
					...
					<tbody>
						<tr>
							...
							<td><a href="#" data-toggle="modal" data-backdrop="static"
								data-target=".examView"> <i class="fa fa-search warning"
									data-toggle="tooltip" data-placement="top" title="查看"
									data-original-title="查看"></i>
							</a> <a href="#" data-toggle="modal" data-target=".examView"
								data-backdrop="static"> <i class="fa fa-phone success"
									data-toggle="tooltip" data-placement="top" title="电话"
								...
								data-backdrop="static"> <i class="fa fa-envelope-o blue"
									data-toggle="tooltip" data-placement="top" title="发送信息"
									data-original-title="发送信息"></i>
							</a> <a href="#" data-toggle="modal" data-target=""
								data-backdrop="static"> <i class="fa fa-download darkorange"
									data-toggle="tooltip" data-placement="top" title="下载"
									data-original-title="下载"></i>
							</a> <a href="#" data-toggle="modal" data-target=".examFee"
								data-backdrop="static"> <i class="fa fa-dollar sky"
									data-toggle="tooltip" data-placement="top" title="报考费"
									data-original-title="报考费"></i>
							</a></td>
						</tr>
						<tr>
							<td width="5%"><label> <input type="checkbox">
...
<!--已报考查看/电话-->
<div class="modal fade in examView" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
     aria-hidden="false" data-backdrop="static">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
...
<!--学员注册-->
<div class="modal fade in enrollment" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
     aria-hidden="false" data-backdrop="static">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <span class="widget-caption">学员注册</span>
            </div>
            <div class="modal-body clearfix">
                <form method="" class="form-horizontal padding-top-20" id="enrollment">
                    <div class="form-group">
                        <label class="control-label col-sm-2 no-padding-left no-padding-right">学习平台连接</label>
                        <div class="col-sm-9 no-padding-right">
                        	<input type="hidden" id="infoId">
                            <input id="platformLink" type="text" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2 no-padding-left no-padding-right">学习账号</label>
                        <div class="col-sm-9 no-padding-right">
                            <input id="platformAccount" type="text" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2 no-padding-left no-padding-right">密码</label>
                        <div class="col-sm-9 no-padding-right">
                            <input id="platformPassword" type="text" class="form-control">
                        </div>
                    </div>
                    <div class="form-group col-sm-12">
                        <div class="col-sm-3 col-sm-offset-4">
                            <button id="regBut" type="button" class="btn btn-primary form-control creation-btn" data-toggle="modal"
...
<!--退回报考费比对-->
<div class="modal fade in examFeeThan" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
     aria-hidden="false" data-backdrop="static">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <span class="widget-caption">退回报考费比对</span>
            </div>
            <div class="modal-body clearfix">
                <form class="form-horizontal" id="examFeeThan" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-12 col-sm-12">
                        <label class="control-label">
                            <div class="col-md-12">
                                <input id="examFee-upload" name="" type="file" multiple>
                            </div>
                        </label>
                    </div>
                    <div class="form-group col-md-12 col-sm-12">
...
<!--报考费-->
<div class="modal fade in examFee" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
     aria-hidden="false" data-backdrop="static">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <span class="widget-caption">报考费</span>
            </div>
            <div class="modal-body clearfix">
                <form class="form-horizontal" id="examFee">
                    <div class="table-scrollable">
                        <table class="table table-striped table-hover table-bordered dataTable no-footer">
                            <thead>
                            <tr role="row" class="text-center">
                            ...
                            <tbody>
                            <tr>
                                <td>2016-05-23 17:46:00</td>
                                <td>132099</td>
                                <td>3300</td>
                                <td>集团支付中培-陕西溢诚渠道1603期西安交通大学合作费</td>
                                <td>杭州中培教育咨询有限公司</td>
                                <td>已批</td>
                                <td>0</td>
                                <td>
                                    <select name="" class="operate">
                                        <option value="">现金</option>
                                        <option value="">刷卡</option>
                                        <option value="">支票</option>
                                        <option value="">汇款-微信</option>
                                        <option value="">汇款-支付宝</option>
                                        <option value="">汇款-网络</option>
                                        <option value="">银行转账</option>
                                    </select>
                                    <input type="text" class="operate">
                                    <a href="#" class='btn btn-blue send-back'  data-toggle="modal" data-backdrop="static" data-target=".examFeeReturn">退回</a>
                                </td>
                            </tr>
                            <tr>
                                <td>2016-05-23 17:46:00</td>
...
<!--报考费退回-->
<div class="modal fade in examFeeReturn" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
     aria-hidden="false" data-backdrop="static">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <span class="widget-caption">报考费退回</span>
            </div>
            <div class="modal-body clearfix">
                <form class="form-horizontal" id="examFeeReturn">
                    <div class="form-group col-sm-12 text-center return-text">
                        是否将 <span>XXXX</span>退回到 <span>XXXXX</span>？
                    </div>
...
<script src="${ctx_static }/home/serviceCenter/js/examWorkbench_exam_flow.js?v=<%=Math.random() %>"></script>
