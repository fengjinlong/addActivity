...
<%@ include file="../common/public_header.jsp"%>
    ...
    <div class="row page-wrapper">
        ...
        <div class="col-sm-3">
            <div class="drop-down menu">
                <div class="widget-header menu-title">
                    <span class="widget-caption" style="line-height:40px !important">菜单管理列表</span>
                ...
                <ul class="nav sidebar-menu">
                	...
                	<li>
                        <a href="#" class="menu-dropdown">
                            ...
                            <input class="sortCode" type="hidden" value="${record.sortCode}"/>
                            <input class="enable" type="hidden" value="${record.enable}"/>
                            <input class="target" type="hidden" value="${record.target}"/>
        ...
        <div class="col-xs-9 col-sm-9 menu-info">
            <div class="widget">
                <div class="widget-header">
                    <span class="widget-caption" style="line-height:40px !important">菜单信息</span>
                ...
                <div class="widget-body">
                    ...
                    <form class="form-horizontal">
                        ...
                        <div class="form-group col-sm-12">
                         ...
                         <div class="form-group col-sm-12">
                            <label class="control-label col-sm-2 no-padding-right">排序号：</label>
                            <div class="col-sm-8">
                                <label class="sortCode"></label>
                            </div>
                        </div>
                         <div class="form-group col-sm-12">
                            <label class="control-label col-sm-2 no-padding-right">按钮类名：</label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-8">
                                <div class="radio pull-left">
                                    <label>
                                        <input class="enable" value="1" name="enable" type="radio">
                                        <span class="text">启用</span>
                                    </label>
                                </div>
                                <div class="radio pull-left">
                                    <label>
                                        <input class="enable" value="0" name="enable" type="radio">
                ...
                <div class="widget-body">
                    <form id="addForm" class="form-horizontal" onsubmit="return addNewRecord();">
                        ...
                        <div class="form-group col-sm-12">
                            <label class="control-label col-sm-2 no-padding-right">排序号：</label>
                            <div class="col-sm-8">
                                <input name="sortCode" class="form-control sortCode" type="input">
                            </div>
                        </div>
                        <div class="form-group col-sm-12">
                            <label class="control-label col-sm-2 no-padding-right">按钮类名：</label>
                            <div class="col-sm-8">
                                 <input name="target" class="form-control target" type="input">
                            </div>
                        </div>
                         <div class="form-group col-sm-12">
                            <label class="control-label col-sm-2 no-padding-right">状态：</label>
    ...
    <script>
    var button = '<div class="operate-btn pull-right">' +
	...
	<script src="${ctx_static }/home/sysconf/js/menu.js?v=<%=Math.random() %>"></script>
