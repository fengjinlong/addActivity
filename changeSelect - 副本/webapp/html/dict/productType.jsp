	...
	<div class="col-lg-12 col-sm-12 col-xs-12">
		<div class="widget">
			<div class="widget-header bordered-bottom bordered-blue">
				 <span class="widget-caption">产品模型模块</span>
			</div>
			<!--Widget Header-->
					...
					<div class="row row_padding form-horizontal">
						<div class="col-md-7 col-sm-7 col-xs-12">
							...
							<div class="form-group col-lg-4 col-md-4 col-sm-4 no-margin-right">
                                <select class="form-control" name="spaceTypeSearch" id="spaceTypeSearch">
                                    <option value="">产品模型类型</option>
                                    <option value="1">基本信息</option>
									<option value="2">条件</option>
									<option value="3">服务项</option>
									<option value="4">价格</option>
									<option value="5">提醒项</option>
                                </select>
                            </div>
			...
			<div class="modal-body clearfix">
				<form class="form-horizontal" id="subjectAdd" method="post">
					<div class="form-group col-sm-12">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control examSubjectName" name="productTypeName">
						</div>
					</div>
					<div class="form-group col-sm-12">
						<label class="control-label col-sm-2 no-padding-right">类型</label>
						<div class="col-sm-9">
							<select name="spaceType" class="form-control examSubjectName">
								<option value="1">基本信息</option>
								<option value="2">条件</option>
								<option value="3">服务项</option>
								<option value="4">价格</option>
	...
	<div class="modal-dialog modal-md">
		<div class="modal-content">
			...
			<div class="modal-body clearfix">
				...
				<input id="productTypeId" type="hidden"/>
					<div class="form-group col-sm-12">
						<label class="control-label col-sm-2 no-padding-right">名称</label>
						<div class="col-sm-9">
					...
					<div class="form-group col-sm-12">
						<label class="control-label col-sm-2 no-padding-right">类型</label>
						<div class="col-sm-9">
							<select id="spaceType" class="form-control examSubjectName">
					...
					<div class="form-group col-sm-12">
						<label class="control-label col-sm-2 no-padding-right">菜单</label>
						<div class="col-sm-9">
							<select id="isMenu" class="form-control examSubjectName">
...
<script src="${ctx_static }/home/dict/js/productType.js?v=<%=Math.random() %>"></script> 
