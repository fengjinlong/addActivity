...
<div class="row page-wrapper">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="widget-header bordered-bottom bordered-blue">
                 <span class="widget-caption">回流资源池</span>
        </div>
	                    ...
	                    <div class="row row_padding form-horizontal">
	                        <div class="col-lg-12 col-sm-12">
	                        	<div class="col-lg-6 col-md-6 col-sm-6">
		                        	<label class="control-label col-sm-4 no-padding-right">本次资源数量</label>
		                            <div class="col-sm-8 no-margin-right">
		                                <input class="form-control" placeholder="0" type="text" id="pieceCount">
		                            </div>
	                            </div>
	                            <div class="col-lg-6 col-md-6 col-sm-6">
	                            	<div class="row buttonCount col-lg-12 col-sm-12">
										  <div class="col-sm-1">
										  </div>
										  <div class="col-sm-2">
											  <button type="button" onclick="changeActive(this)" class="btn btn-default">10</button>
										  </div>
										  <div class="col-sm-2">
											  <button type="button" onclick="changeActive(this)" class="btn btn-default">20</button>
									      </div>
									      <div class="col-sm-2">
											  <button type="button" onclick="changeActive(this)" class="btn btn-primary">30</button>
										  </div>
										  <div class="col-sm-2">
											  <button type="button" onclick="changeActive(this)" class="btn btn-default">40</button>
										  </div>
										  <div class="col-sm-2">  
											  <button type="button" onclick="changeActive(this)" class="btn btn-default">50</button>
										  </div>
										  <div class="col-sm-1">
										  </div>
							  		</div>
	                        ...
	                        <div class="col-lg-12 col-md-12 col-sm-12 form-line">
	                         
							  <div class="row" style="margin-top:20px">
						  		<div class="col-sm-4"></div>
						  		<div class="col-sm-4">
						  			<button class="btn btn-large btn-block btn-primary" type="button" onclick="grabTreasure(this)">准备开抢</button>
						  		</div>
...
<!--引入提示框插件 -->
<%-- <script src="${ctx}/statics/dep/assets/js/bootbox/bootbox.js"></script> --%>
...
<!--藏宝阁 -->
<script src="${ctx_static }/home/consultcenter/js/treasureHouse.js"></script>
<!--回流资源分配-查看信息弹框-课程信息回显 -->
<script src="${ctx_static }/home/consultcenter/js/backProjectInfo.js"></script>
<!-- 回流资源分配 -->
<script src="${ctx_static }/home/consultcenter/js/infoDistributionForBack.js"></script>